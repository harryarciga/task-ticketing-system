...
def add_to_google_sheets(data):
    ...
    try:
        result = (
            ...
            .append(
                spreadsheetId=SPREADSHEET_ID,
                range="Tickets!A:H",  # Adjust range if necessary
...
class MyView(discord.ui.View):
    ...
    async def edit_task(self, interaction: discord.Interaction, button: discord.ui.Button):
        await interaction.response.send_message("Please type the **task ID** of the task you wish to change in the chatbox below with this format:\n2425-XXXXX", ephemeral=True)

        def check(msg):
            return msg.author == interaction.user and msg.channel == interaction.channel

        msg = await client.wait_for("message", check=check)
        task_id = msg.content  # Extract the task id
...
class Priority(discord.ui.View):
    ...
    async def critical(self, interaction: discord.Interaction, button: discord.ui.Button):
        await interaction.response.send_message("You selected **P0 - Critical** as the task priority.\nSelect the **committee requesting** the task:", view=RequestingCommittee(self.context, self.task_name, "P0 - Critical"), ephemeral=True)

    @discord.ui.button(label="P1 - High", style=discord.ButtonStyle.secondary)
    async def high(self, interaction: discord.Interaction, button: discord.ui.Button):
        await interaction.response.send_message("You selected **P1 - High** as the task priority.\nSelect the **committee requesting** the task:", view=RequestingCommittee(self.context, self.task_name, "P1 - High"), ephemeral=True)
    ...
    async def moderate(self, interaction: discord.Interaction, button: discord.ui.Button):
        await interaction.response.send_message("You selected **P2 - Moderate** as the task priority.\nSelect the **committee requesting** the task:", view=RequestingCommittee(self.context, self.task_name, "P2 - Moderate"), ephemeral=True)

    @discord.ui.button(label="P3 - Low", style=discord.ButtonStyle.primary)
    async def low(self, interaction: discord.Interaction, button: discord.ui.Button):
        await interaction.response.send_message("You selected **P3 - Low** as the task priority.\nSelect the **committee requesting** the task:", view=RequestingCommittee(self.context, self.task_name, "P3 - Low"), ephemeral=True)
    ...
    async def optional(self, interaction: discord.Interaction, button: discord.ui.Button):
        await interaction.response.send_message("You selected **P4 - Optional** as the task priority.\nSelect the **committee requesting** the task:", view=RequestingCommittee(self.context, self.task_name, "P4 - Optional"), ephemeral=True)
...
class RequestingCommittee(discord.ui.View):
    ...
    async def request_SB(self, interaction: discord.Interaction, button: discord.ui.Button):
        await interaction.response.send_message("You selected **SB** as the committee requesting for the task.\nSelect the **committee assigned or responsible** for the task:", view=CommitteeResponsible(self.context, self.task_name, self.priority, "SB"), ephemeral=True)
    ...
    async def request_CM(self, interaction: discord.Interaction, button: discord.ui.Button):
        await interaction.response.send_message("You selected **CM** as the committee requesting for the task.\nSelect the **committee assigned or responsible** for the task:", view=CommitteeResponsible(self.context, self.task_name, self.priority, "CM"), ephemeral=True)
    ...
    async def request_CX(self, interaction: discord.Interaction, button: discord.ui.Button):
        await interaction.response.send_message("You selected **CX** as the committee requesting for the task.\nSelect the **committee assigned or responsible** for the task:", view=CommitteeResponsible(self.context, self.task_name, self.priority, "CX"), ephemeral=True)
    ...
    async def request_HR(self, interaction: discord.Interaction, button: discord.ui.Button):
        await interaction.response.send_message("You selected **HR** as the committee requesting for the task.\nSelect the **committee assigned or responsible** for the task:", view=CommitteeResponsible(self.context, self.task_name, self.priority, "HR"), ephemeral=True)
    ...
    async def request_IT(self, interaction: discord.Interaction, button: discord.ui.Button):
        await interaction.response.send_message("You selected **IT** as the committee requesting for the task.\nSelect the **committee assigned or responsible** for the task:", view=CommitteeResponsible(self.context, self.task_name, self.priority, "IT"), ephemeral=True)
    ...
    async def request_MK(self, interaction: discord.Interaction, button: discord.ui.Button):
        await interaction.response.send_message("You selected **MK** as the committee requesting for the task.\nSelect the **committee assigned or responsible** for the task:", view=CommitteeResponsible(self.context, self.task_name, self.priority, "MK"), ephemeral=True)
    ...
    async def request_FS(self, interaction: discord.Interaction, button: discord.ui.Button):
        await interaction.response.send_message("You selected **FS** as the committee requesting for the task.\nSelect the **committee assigned or responsible** for the task:", view=CommitteeResponsible(self.context, self.task_name, self.priority, "FS"), ephemeral=True)
...
class CommitteeResponsible(discord.ui.View):
    ...
    async def responsible_SB(self, interaction: discord.Interaction, button: discord.ui.Button):
        await interaction.response.send_message("You selected **SB** as the committee assigned for the task.\nSelect the **subcommittee assigned or responsible** for the task:", view=SubcommitteeResponsibleSB(self.context, self.task_name, self.priority, self.requesting_committee, "SB"), ephemeral=True)

    @discord.ui.button(label="CM", style=discord.ButtonStyle.secondary)
    async def responsible_CM(self, interaction: discord.Interaction, button: discord.ui.Button):
        await interaction.response.send_message("You selected **CM** as the committee assigned for the task.\nSelect the **subcommittee assigned or responsible** for the task:", view=SubcommitteeResponsibleCM(self.context, self.task_name, self.priority, self.requesting_committee, "CM"), ephemeral=True)

    @discord.ui.button(label="CX", style=discord.ButtonStyle.success)
    async def responsible_CX(self, interaction: discord.Interaction, button: discord.ui.Button):
        await interaction.response.send_message("You selected **CX** as the committee assigned for the task.\nSelect the **subcommittee assigned or responsible** for the task:", view=SubcommitteeResponsibleCX(self.context, self.task_name, self.priority, self.requesting_committee, "CX"), ephemeral=True)

    @discord.ui.button(label="HR", style=discord.ButtonStyle.primary)
    async def responsible_HR(self, interaction: discord.Interaction, button: discord.ui.Button):
        await interaction.response.send_message("You selected **HR** as the committee assigned for the task.\nSelect the **subcommittee assigned or responsible** for the task:", view=SubcommitteeResponsibleHR(self.context, self.task_name, self.priority, self.requesting_committee, "HR"), ephemeral=True)

    @discord.ui.button(label="IT", style=discord.ButtonStyle.secondary)
    async def responsible_IT(self, interaction: discord.Interaction, button: discord.ui.Button):
        await interaction.response.send_message("You selected **IT** as the committee assigned for the task.\nSelect the **subcommittee assigned or responsible** for the task:", view=SubcommitteeResponsibleIT(self.context, self.task_name, self.priority, self.requesting_committee, "IT"), ephemeral=True)

    @discord.ui.button(label="MK", style=discord.ButtonStyle.success)
    async def responsible_MK(self, interaction: discord.Interaction, button: discord.ui.Button):
        await interaction.response.send_message("You selected **MK** as the committee assigned for the task.\nSelect the **subcommittee assigned or responsible** for the task:", view=SubcommitteeResponsibleMK(self.context, self.task_name, self.priority, self.requesting_committee, "MK"), ephemeral=True)

    @discord.ui.button(label="FS", style=discord.ButtonStyle.primary)
    async def responsible_FS(self, interaction: discord.Interaction, button: discord.ui.Button):
        await interaction.response.send_message("You selected **FS** as the committee assigned for the task.\nSelect the **subcommittee assigned or responsible** for the task:", view=SubcommitteeResponsibleFS(self.context, self.task_name, self.priority, self.requesting_committee, "FS"), ephemeral=True)
...
class SubcommitteeResponsibleSB(discord.ui.View):
    ...
    async def president_SB(self, interaction: discord.Interaction, button: discord.ui.Button):
        await interaction.response.send_message("You selected **President (SB)** as the subcommittee assigned for the task.\nSelect the **committee receiving the output** of the task:", view=ReceivingCommittee(self.context, self.task_name, self.priority, self.requesting_committee, self.committee_responsible, "President (SB)"), ephemeral=True)
    ...
    async def evp_SB(self, interaction: discord.Interaction, button: discord.ui.Button):
        await interaction.response.send_message("You selected **Executive Vice President (SB)** as the subcommittee assigned for the task.\nSelect the **committee receiving the output** of the task:", view=ReceivingCommittee(self.context, self.task_name, self.priority, self.requesting_committee, self.committee_responsible, "Executive Vice President (SB)"), ephemeral=True)
    ...
    async def process_ex_SB(self, interaction: discord.Interaction, button: discord.ui.Button):
        await interaction.response.send_message("You selected **Process Excellence (SB)** as the subcommittee assigned for the task.\nSelect the **committee receiving the output** of the task:", view=ReceivingCommittee(self.context, self.task_name, self.priority, self.requesting_committee, self.committee_responsible, "Process Excellence (SB)"), ephemeral=True)
    ...
    async def university_affairs_SB(self, interaction: discord.Interaction, button: discord.ui.Button):
        await interaction.response.send_message("You selected **University Affairs (SB)** as the subcommittee assigned for the task.\nSelect the **committee receiving the output** of the task:", view=ReceivingCommittee(self.context, self.task_name, self.priority, self.requesting_committee, self.committee_responsible, "University Affairs (SB)"), ephemeral=True)
...
class SubcommitteeResponsibleCM(discord.ui.View):
    ...
    async def vp_CM(self, interaction: discord.Interaction, button: discord.ui.Button):
        await interaction.response.send_message("You selected **Vice President (CM)** as the subcommittee assigned for the task.\nSelect the **committee receiving the output** of the task:", view=ReceivingCommittee(self.context, self.task_name, self.priority, self.requesting_committee, self.committee_responsible, "Vice President (CM)"), ephemeral=True)
    ...
    async def brand_CM(self, interaction: discord.Interaction, button: discord.ui.Button):
        await interaction.response.send_message("You selected **Brand Management (CM)** as the subcommittee assigned for the task.\nSelect the **committee receiving the output** of the task:", view=ReceivingCommittee(self.context, self.task_name, self.priority, self.requesting_committee, self.committee_responsible, "Brand Management (CM)"), ephemeral=True)
    ...
    async def external_CM(self, interaction: discord.Interaction, button: discord.ui.Button):
        await interaction.response.send_message("You selected **External Communications (CM)** as the subcommittee assigned for the task.\nSelect the **committee receiving the output** of the task:", view=ReceivingCommittee(self.context, self.task_name, self.priority, self.requesting_committee, self.committee_responsible, "External Communications (CM)"), ephemeral=True)
...
class SubcommitteeResponsibleCX(discord.ui.View):
    ...
    async def vp_CX(self, interaction: discord.Interaction, button: discord.ui.Button):
        await interaction.response.send_message("You selected **Vice President (CX)** as the subcommittee assigned for the task.\nSelect the **committee receiving the output** of the task:", view=ReceivingCommittee(self.context, self.task_name, self.priority, self.requesting_committee, self.committee_responsible, "Vice President (CX)"), ephemeral=True)
    ...
    async def customer_CX(self, interaction: discord.Interaction, button: discord.ui.Button):
        await interaction.response.send_message("You selected **Customer Development (CX)** as the subcommittee assigned for the task.\nSelect the **committee receiving the output** of the task:", view=ReceivingCommittee(self.context, self.task_name, self.priority, self.requesting_committee, self.committee_responsible, "Customer Development (CX)"), ephemeral=True)
    ...
    async def sales_CX(self, interaction: discord.Interaction, button: discord.ui.Button):
        await interaction.response.send_message("You selected **Sales (CX)** as the subcommittee assigned for the task.\nSelect the **committee receiving the output** of the task:", view=ReceivingCommittee(self.context, self.task_name, self.priority, self.requesting_committee, self.committee_responsible, "Sales (CX)"), ephemeral=True)
...
class SubcommitteeResponsibleHR(discord.ui.View):
    ...
    async def vp_HR(self, interaction: discord.Interaction, button: discord.ui.Button):
        await interaction.response.send_message("You selected **Vice President (HR)** as the subcommittee assigned for the task.\nSelect the **committee receiving the output** of the task:", view=ReceivingCommittee(self.context, self.task_name, self.priority, self.requesting_committee, self.committee_responsible, "Vice President (HR)"), ephemeral=True)
    ...
    async def performance_HR(self, interaction: discord.Interaction, button: discord.ui.Button):
        await interaction.response.send_message("You selected **Performance Management (HR)** as the subcommittee assigned for the task.\nSelect the **committee receiving the output** of the task:", view=ReceivingCommittee(self.context, self.task_name, self.priority, self.requesting_committee, self.committee_responsible, "Performance Management (HR)"), ephemeral=True)
    ...
    async def membership_HR(self, interaction: discord.Interaction, button: discord.ui.Button):
        await interaction.response.send_message("You selected **Membership (HR)** as the subcommittee assigned for the task.\nSelect the **committee receiving the output** of the task:", view=ReceivingCommittee(self.context, self.task_name, self.priority, self.requesting_committee, self.committee_responsible, "Membership (HR)"), ephemeral=True)
    ...
    async def org_HR(self, interaction: discord.Interaction, button: discord.ui.Button):
        await interaction.response.send_message("You selected **Organization Management (HR)** as the subcommittee assigned for the task.\nSelect the **committee receiving the output** of the task:", view=ReceivingCommittee(self.context, self.task_name, self.priority, self.requesting_committee, self.committee_responsible, "Organization Management (HR)"), ephemeral=True)
...
class SubcommitteeResponsibleIT(discord.ui.View):
    ...
    async def vp_IT(self, interaction: discord.Interaction, button: discord.ui.Button):
        await interaction.response.send_message("You selected **Vice President (IT)** as the subcommittee assigned for the task.\nSelect the **committee receiving the output** of the task:", view=ReceivingCommittee(self.context, self.task_name, self.priority, self.requesting_committee, self.committee_responsible, "Vice President (IT)"), ephemeral=True)
    ...
    async def web_IT(self, interaction: discord.Interaction, button: discord.ui.Button):
        await interaction.response.send_message("You selected **Web Development (IT)** as the subcommittee assigned for the task.\nSelect the **committee receiving the output** of the task:", view=ReceivingCommittee(self.context, self.task_name, self.priority, self.requesting_committee, self.committee_responsible, "Web Development (IT)"), ephemeral=True)
    ...
    async def info_IT(self, interaction: discord.Interaction, button: discord.ui.Button):
        await interaction.response.send_message("You selected **Information Systems (IT)** as the subcommittee assigned for the task.\nSelect the **committee receiving the output** of the task:", view=ReceivingCommittee(self.context, self.task_name, self.priority, self.requesting_committee, self.committee_responsible, "Information Systems (IT)"), ephemeral=True)
    ...
    async def auto_IT(self, interaction: discord.Interaction, button: discord.ui.Button):
        await interaction.response.send_message("You selected **Automation (IT)** as the subcommittee assigned for the task.\nSelect the **committee receiving the output** of the task:", view=ReceivingCommittee(self.context, self.task_name, self.priority, self.requesting_committee, self.committee_responsible, "Automation (IT)"), ephemeral=True)
...
class SubcommitteeResponsibleMK(discord.ui.View):
    ...
    async def vp_MK(self, interaction: discord.Interaction, button: discord.ui.Button):
        await interaction.response.send_message("You selected **Vice President (MK)** as the subcommittee assigned for the task.\nSelect the **committee receiving the output** of the task:", view=ReceivingCommittee(self.context, self.task_name, self.priority, self.requesting_committee, self.committee_responsible, "Vice President (MK)"), ephemeral=True)
    ...
    async def exte_MK(self, interaction: discord.Interaction, button: discord.ui.Button):
        await interaction.response.send_message("You selected **External Relations (MK)** as the subcommittee assigned for the task.\nSelect the **committee receiving the output** of the task:", view=ReceivingCommittee(self.context, self.task_name, self.priority, self.requesting_committee, self.committee_responsible, "External Operations (MK)"), ephemeral=True)
    ...
    async def market_MK(self, interaction: discord.Interaction, button: discord.ui.Button):
        await interaction.response.send_message("You selected **Marketing Operations (MK)** as the subcommittee assigned for the task.\nSelect the **committee receiving the output** of the task:", view=ReceivingCommittee(self.context, self.task_name, self.priority, self.requesting_committee, self.committee_responsible, "Marketing Operations (MK)"), ephemeral=True)
...
class SubcommitteeResponsibleFS(discord.ui.View):
    ...
    async def vp_FS(self, interaction: discord.Interaction, button: discord.ui.Button):
        await interaction.response.send_message("You selected **Vice President (FS)** as the subcommittee assigned for the task.\nSelect the **committee receiving the output** of the task:", view=ReceivingCommittee(self.context, self.task_name, self.priority, self.requesting_committee, self.committee_responsible, "Vice President (FS)"), ephemeral=True)
    ...
    async def events_FS(self, interaction: discord.Interaction, button: discord.ui.Button):
        await interaction.response.send_message("You selected **Events Operations (FS)** as the subcommittee assigned for the task.\nSelect the **committee receiving the output** of the task:", view=ReceivingCommittee(self.context, self.task_name, self.priority, self.requesting_committee, self.committee_responsible, "Events Operations (FS)"), ephemeral=True)
    ...
    async def exte_FS(self, interaction: discord.Interaction, button: discord.ui.Button):
        await interaction.response.send_message("You selected **External Operations (FS)** as the subcommittee assigned for the task.\nSelect the **committee receiving the output** of the task:", view=ReceivingCommittee(self.context, self.task_name, self.priority, self.requesting_committee, self.committee_responsible, "External Operations (FS)"), ephemeral=True)
    ...
    async def taiwan_FS(self, interaction: discord.Interaction, button: discord.ui.Button):
        await interaction.response.send_message("You selected **Taiwan (FS)** as the subcommittee assigned for the task.\nSelect the **committee receiving the output** of the task:", view=ReceivingCommittee(self.context, self.task_name, self.priority, self.requesting_committee, self.committee_responsible, "Taiwan (FS)"), ephemeral=True)
    ...
    async def capes_FS(self, interaction: discord.Interaction, button: discord.ui.Button):
        await interaction.response.send_message("You selected **CAPES Week (FS)** as the subcommittee assigned for the task.\nSelect the **committee receiving the output** of the task:", view=ReceivingCommittee(self.context, self.task_name, self.priority, self.requesting_committee, self.committee_responsible, "CAPES Week (FS)"), ephemeral=True)
    ...
    async def upskill_FS(self, interaction: discord.Interaction, button: discord.ui.Button):
        await interaction.response.send_message("You selected **Upskill (FS)** as the subcommittee assigned for the task.\nSelect the **committee receiving the output** of the task:", view=ReceivingCommittee(self.context, self.task_name, self.priority, self.requesting_committee, self.committee_responsible, "Upskill (FS)"), ephemeral=True)
    ...
    async def jobfair_FS(self, interaction: discord.Interaction, button: discord.ui.Button):
        await interaction.response.send_message("You selected **JobFair (FS)** as the subcommittee assigned for the task.\nSelect the **committee receiving the output** of the task:", view=ReceivingCommittee(self.context, self.task_name, self.priority, self.requesting_committee, self.committee_responsible, "JobFair (FS)"), ephemeral=True)
    ...
    async def mixer_FS(self, interaction: discord.Interaction, button: discord.ui.Button):
        await interaction.response.send_message("You selected **Mixer (FS)** as the subcommittee assigned for the task.\nSelect the **committee receiving the output** of the task:", view=ReceivingCommittee(self.context, self.task_name, self.priority, self.requesting_committee, self.committee_responsible, "Mixer (FS)"), ephemeral=True)
...
class ReceivingCommittee(discord.ui.View):
    ...
    async def receiving_SB(self, interaction: discord.Interaction, button: discord.ui.Button):
        ...
        await interaction.followup.send(
            f"Please type your **display name** as the creator of this task.",
            ephemeral=True,
        )

        display_name_msg = await client.wait_for("message", check=check)
        creator_name = display_name_msg.content

        await interaction.followup.send(
            f"Lastly, please type the **display name/s** of the specific person/s resposnsible for the task.\nExample for one person: Juan\nExample for 2 or more persons: Juan, joaquin23, hello2025",
            ephemeral=True,
        )

        respo_name_msg = await client.wait_for("message", check=check)
        respo_name = respo_name_msg.content
        ...
        embed = discord.Embed(
            ...
            description=(
                ...
                f"**Due Date:** {deadline}\n"
                f"**Notes:** {notes}"
                f"**Task Creator: {creator_name}"
                f"**Person/s in Charge: {respo_name}"
            ),
            color=0xffcc1a,
        )
